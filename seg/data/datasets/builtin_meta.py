...
ISIC2016_CATEGORIES = [
    {"color": [0, 0, 0], "id": 0, "name": "background"},
    {"color": [255, 255, 255], "id": 1, "name": "lesion"},
]

'''
ISIC2016_CATEGORIES = [
    {"color": [140, 210, 240], "id": 1, "name": "lesion"},
]
'''

def _get_skinlesion_meta():
    stuff_classes = [k["name"] for k in ISIC2016_CATEGORIES]
    stuff_colors = [k["color"] for k in ISIC2016_CATEGORIES]
    ret = {
        "stuff_classes": stuff_classes,
        "stuff_colors": stuff_colors,
        "ignore_label": 255,
...
def _get_builtin_metadata(dataset_name):
    ...
    elif dataset_name in ["isic2016", "isic2017", "isic2018", "ph2", "7point"]:
        return _get_skinlesion_meta()
